...
export default function IndustrySEO() {
  return (
    <section className="py-24 md:py-36 bg-[#FAF8F4] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <SectionHeader 
          title="SEO основа за по-добра видимост"
          subtitle="Всяка страница е подготвена по съвременните изисквания за класиране в Google."
          className="mb-16 md:mb-20"
        />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sharedSEO.map((item, idx) => (
